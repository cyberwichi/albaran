              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-for="(linea, index) in pedido" :key="index">
                    <th v-if="'articulo' in linea" scope="row">
      ...
      if (this.idaviso) {
        ...
        axios
          ...
          .then((response) => {
            ...
            this.franquiciado = this.aviso[0].franquiciado;
            document.getElementById("app").style.cursor = "auto";
          })
          .catch((e) => {
            console.log(e);
